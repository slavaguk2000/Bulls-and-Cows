...
![Окно отображения состояния игры](../../Images/Mockups/stateTable.png)  
Окно для ввода(загадывания) своего числа.  
![Окно для ввода(загадывания) своего числа](../../Images/Mockups/makeNumber.png)  
Окно для угадывания числа противника.  
![Окно для угадывания числа противника](../../Images/Mockups/guessNumber.png)  
Окно выбора повтора или окончания игры.  
![Окно выбора повтора или окончания игры](../../Images/Mockups/repeatGame.png)  
